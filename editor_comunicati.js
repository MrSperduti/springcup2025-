document.addEventListener("DOMContentLoaded", function() {
  ...
  function renderTable(files) {
    ...
    files.forEach(file => {
      ...
      removeButton.onclick = function() {
        ...
        localStorage.setItem('comunicatiFiles', JSON.stringify(updatedFiles));
  ...
  uploadFileButton.addEventListener('click', function() {
    ...
    if (file) {
      ...
      let existingFiles = [];
      if (localStorage.getItem('comunicatiFiles')) {
        existingFiles = JSON.parse(localStorage.getItem('comunicatiFiles'));
      }
      ...
      localStorage.setItem('comunicatiFiles', JSON.stringify(existingFiles));
  ...
  generateJsonButton.addEventListener('click', function() {
    ...
    const jsonBlob = new Blob([JSON.stringify({comunicatiFiles: JSON.parse(localStorage.getItem('comunicatiFiles'))})], {type: 'application/json'});
  ...
  if (localStorage.getItem('comunicatiFiles')) {
    renderTable(JSON.parse(localStorage.getItem('comunicatiFiles')));
  }
});
